...
var WyvernProtocol = /** @class */ (function () {
    function WyvernProtocol(provider, config) {
        ...
        var wyvern2_2ProxyRegistryContractAddress = config.network === types_1.Network.Main
            ? '0xa5409ec958c83c3f309868babaca7c86dcb077c1'
            : '0xf57b2c51ded3a29e6891aba85459d600256cf317';
        this.wyvern2_2ProxyRegistry = new wyvern_proxy_registry_1.WyvernProxyRegistryContract(this._web3Wrapper.getContractInstance(constants_1.constants.PROXY_REGISTRY_ABI, wyvern2_2ProxyRegistryContractAddress), {});
    ...
    WyvernProtocol.prototype.getAuthenticatedProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.wyvern2_2ProxyRegistry.proxies.callAsync(accountAddress)];
                    case 1:
