...
var WyvernProtocol = /** @class */ (function () {
    function WyvernProtocol(provider, config) {
        ...
        var exchangeContractAddress = config.wyvernExchangeContractAddress ||
        ...
        var proxyRegistryContractAddress = config.wyvernProxyRegistryContractAddress ||
        ...
        var daoContractAddress = config.wyvernDAOContractAddress ||
        ...
        var tokenContractAddress = config.wyvernTokenContractAddress ||
        ...
        var atomicizerContractAddress = config.wyvernAtomicizerContractAddress ||
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._web3Wrapper.signMessageAsync(signerAddress, msgHashHex)];
                    case 2:
                        signature = _a.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this._web3Wrapper.getTransactionReceiptIfExistsAsync(txHash)];
                                case 1:
                                    ...
                                    if (transactionReceipt && this._abiDecoder) {
                                        ...
                                        transactionReceiptWithDecodedLogArgs = __assign(__assign({}, transactionReceipt), { logs: logsWithDecodedArgs });
    ...
    WyvernProtocol.encodeReplacementPattern = function (abi, replaceKind, encodeToBytes) {
        ...
        var mask = Buffer.concat([
            methodIdMask,
            Buffer.concat(output.concat(data)),
        ]);
        return encodeToBytes
            ? "0x".concat(mask.toString('hex'))
            : mask.map(function (b) { return (b ? 1 : 0); }).join('');
    };
    /**
