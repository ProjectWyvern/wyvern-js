...
var WyvernProtocol = /** @class */ (function () {
     ...
     */
    WyvernProtocol.encodeReplacementPattern = function (abi, replaceKind) {
        ...
        abi.inputs.map(function (i) {
            ...
            var encoded = ethABI.encodeSingle(type, WyvernProtocol.generateDefaultValue(i.type));
    ...
    WyvernProtocol.encodeAtomicizedReplacementPattern = function (abis, replaceKind) {
        ...
        var encoded = ethABI.encodeSingle(ethABI.elementaryName('uint256'), WyvernProtocol.generateDefaultValue('uint256'));
        maskArr.push(doNotAllowReplaceByte.repeat(encoded.length * 3));
        // Plus transfer inputs * abis.length
        abis.map(function (abi) {
            maskArr.push(doNotAllowReplaceByte.repeat(encoded.length * abi.inputs.length));
        });
