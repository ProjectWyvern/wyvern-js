...
const authenticated_proxy_1 = require("./abi_gen/authenticated_proxy");
...
class WyvernProtocol {
     ...
     */
    getAuthenticatedProxy(accountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const proxyAddress = yield this.wyvernProxyRegistry
                .proxies(accountAddress)
                .callAsync();
            return new authenticated_proxy_1.AuthenticatedProxyContract(proxyAddress, this._provider);
        });
    }
}
