...
exports.utils = {
    ...
    getOrderHashHex(order) {
        const orderParts = [
            ...
            { value: Buffer.from(order.calldata.slice(2), 'hex'), type: types_1.SolidityTypes.Bytes },
            { value: Buffer.from(order.replacementPattern.slice(2), 'hex'), type: types_1.SolidityTypes.Bytes },
            { value: order.staticTarget, type: types_1.SolidityTypes.Address },
            { value: Buffer.from(order.staticExtradata.slice(2), 'hex'), type: types_1.SolidityTypes.Bytes },
