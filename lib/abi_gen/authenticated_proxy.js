...
class AuthenticatedProxyContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = AuthenticatedProxyContract.deployedBytecode, encoderOverrides) {
        super('AuthenticatedProxy', AuthenticatedProxyContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(AuthenticatedProxyContract.ABI(), this._web3Wrapper);
        AuthenticatedProxyContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return AuthenticatedProxyContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield AuthenticatedProxyContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`AuthenticatedProxy successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new AuthenticatedProxyContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield AuthenticatedProxyContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = AuthenticatedProxyContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    initialize(addrUser, addrRegistry) {
        const self = this;
        ...
        return {
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [addrUser.toLowerCase(),
                    addrRegistry.toLowerCase()
                ]);
            },
        };
    }
    ...
    proxy(dest, howToCall, calldata) {
        ...
        return {
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [dest.toLowerCase(),
                    howToCall,
                    calldata
                ]);
            },
    ...
    proxyAssert(dest, howToCall, calldata) {
        const self = this;
        assert_1.assert.isString('dest', dest);
        assert_1.assert.isNumberOrBigNumber('howToCall', howToCall);
        assert_1.assert.isString('calldata', calldata);
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, AuthenticatedProxyContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, AuthenticatedProxyContract.ABI());
            return logs;
        });
    }
}
