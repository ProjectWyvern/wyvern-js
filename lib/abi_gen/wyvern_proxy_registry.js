...
exports.WyvernProxyRegistryContract = exports.WyvernProxyRegistryEvents = void 0;
...
var WyvernProxyRegistryEvents;
(function (WyvernProxyRegistryEvents) {
    WyvernProxyRegistryEvents["OwnershipRenounced"] = "OwnershipRenounced";
    WyvernProxyRegistryEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(WyvernProxyRegistryEvents = exports.WyvernProxyRegistryEvents || (exports.WyvernProxyRegistryEvents = {}));
...
var WyvernProxyRegistryContract = /** @class */ (function (_super) {
    ...
    function WyvernProxyRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides) {
        if (deployedBytecode === void 0) { deployedBytecode = WyvernProxyRegistryContract.deployedBytecode; }
        var _this = _super.call(this, 'WyvernProxyRegistry', WyvernProxyRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(WyvernProxyRegistryContract.ABI(), _this._web3Wrapper);
        WyvernProxyRegistryContract.ABI().forEach(function (item, index) {
    ...
    WyvernProxyRegistryContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, WyvernProxyRegistryContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    WyvernProxyRegistryContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, WyvernProxyRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    WyvernProxyRegistryContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("WyvernProxyRegistry successfully deployed at ".concat(txReceipt.contractAddress));
                        contractInstance = new WyvernProxyRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    WyvernProxyRegistryContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [],
    ...
    WyvernProxyRegistryContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, WyvernProxyRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 3:
                        // Deploy any dependent libraries used by this library.
                        _d.sent();
    ...
    WyvernProxyRegistryContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = WyvernProxyRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = (0, base_contract_1.methodAbiToFunctionSignature)(methodAbi);
        return functionSignature;
    };
    WyvernProxyRegistryContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    WyvernProxyRegistryContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
    ...
    WyvernProxyRegistryContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    WyvernProxyRegistryContract.prototype.name = function () {
        var self = this;
    ...
    WyvernProxyRegistryContract.prototype.initialAddressSet = function () {
        var self = this;
        var functionSignature = 'initialAddressSet()';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.endGrantAuthentication = function (addr) {
        var self = this;
        assert_1.assert.isString('addr', addr);
        var functionSignature = 'endGrantAuthentication(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
    ...
    WyvernProxyRegistryContract.prototype.revokeAuthentication = function (addr) {
        var self = this;
        assert_1.assert.isString('addr', addr);
        var functionSignature = 'revokeAuthentication(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            sendTransactionAsync: function (txData, opts) {
    ...
    WyvernProxyRegistryContract.prototype.pending = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
        var functionSignature = 'pending(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.contracts = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
        var functionSignature = 'contracts(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.renounceOwnership = function () {
        var self = this;
    ...
    WyvernProxyRegistryContract.prototype.owner = function () {
        var self = this;
    ...
    WyvernProxyRegistryContract.prototype.delegateProxyImplementation = function () {
        var self = this;
        var functionSignature = 'delegateProxyImplementation()';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.proxies = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
        var functionSignature = 'proxies(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.startGrantAuthentication = function (addr) {
        var self = this;
        assert_1.assert.isString('addr', addr);
        var functionSignature = 'startGrantAuthentication(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            sendTransactionAsync: function (txData, opts) {
    ...
    WyvernProxyRegistryContract.prototype.registerProxy = function () {
        var self = this;
        var functionSignature = 'registerProxy()';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            sendTransactionAsync: function (txData, opts) {
    ...
    WyvernProxyRegistryContract.prototype.DELAY_PERIOD = function () {
        var self = this;
        var functionSignature = 'DELAY_PERIOD()';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            callAsync: function (callData, defaultBlock) {
    ...
    WyvernProxyRegistryContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
    ...
    WyvernProxyRegistryContract.prototype.grantInitialAuthentication = function (authAddress) {
        var self = this;
        assert_1.assert.isString('authAddress', authAddress);
        var functionSignature = 'grantInitialAuthentication(address)';
        var selector = self._lookupAbiEncoder(functionSignature).getSelector();
        return {
            selector: selector,
            sendTransactionAsync: function (txData, opts) {
     ...
     */
    WyvernProxyRegistryContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, WyvernProxyRegistryEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, WyvernProxyRegistryContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    WyvernProxyRegistryContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    WyvernProxyRegistryContract.prototype.unsubscribeAll = function () {
     ...
     */
    WyvernProxyRegistryContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, WyvernProxyRegistryContract.ABI())];
                    case 1:
                        logs = _a.sent();
