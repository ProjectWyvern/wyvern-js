...
export type AuthenticatedProxyEventArgs =
    | AuthenticatedProxyRevokedEventArgs
    | AuthenticatedProxyReceivedEtherEventArgs
    | AuthenticatedProxyReceivedTokensEventArgs;

export enum AuthenticatedProxyEvents {
    Revoked = 'Revoked',
...
public static contractName = 'AuthenticatedProxy';
    private readonly _methodABIIndex: { [name: string]: number } = {};
private readonly _subscriptionManager: SubscriptionManager<AuthenticatedProxyEventArgs, AuthenticatedProxyEvents>;
public static async deployFrom0xArtifactAsync(
    ...
    public static async deployWithLibrariesFrom0xArtifactAsync(
        ...
        const libraryAddresses = await AuthenticatedProxyContract._deployLibrariesAsync(
            artifact,
            libraryArtifacts,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`AuthenticatedProxy successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new AuthenticatedProxyContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
        ...
        for (const link of Object.values(links)) {
            for (const libraryName of Object.keys(link)) {
                if (!libraryAddresses[libraryName]) {
                    ...
                    await AuthenticatedProxyContract._deployLibrariesAsync(
                        libraryArtifact,
                        libraryArtifacts,
                        web3Wrapper,
                        txDefaults,
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = AuthenticatedProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
...
> {
     ...
     */
    public subscribe<ArgsType extends AuthenticatedProxyEventArgs>(
        eventName: AuthenticatedProxyEvents,
        indexFilterValues: IndexedFilterValues,
        callback: EventCallback<ArgsType>,
        isVerbose: boolean = false,
        blockPollingIntervalMs?: number,
    ): string {
        assert.doesBelongToStringEnum('eventName', eventName, AuthenticatedProxyEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe<ArgsType>(
            ...
            eventName,
            indexFilterValues,
            AuthenticatedProxyContract.ABI(),
            callback,
            isVerbose,
     ...
     */
    public async getLogsAsync<ArgsType extends AuthenticatedProxyEventArgs>(
        eventName: AuthenticatedProxyEvents,
    ...
    constructor(
        ...
        txDefaults?: Partial<TxData>,
        logDecodeDependencies?: { [contractName: string]: ContractAbi },
        deployedBytecode: string | undefined = AuthenticatedProxyContract.deployedBytecode,
...
this._subscriptionManager = new SubscriptionManager<AuthenticatedProxyEventArgs, AuthenticatedProxyEvents>(
            AuthenticatedProxyContract.ABI(),
            this._web3Wrapper,
        );
